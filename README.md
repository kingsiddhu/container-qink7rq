...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qink7rq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qink7rq.containers.anotherwebservice.com/
...
```
git clone git@github.com:kingsiddhu/container-qink7rq.git
cd container-qink7rq
```
...
```
docker attach container-qink7rq
```
